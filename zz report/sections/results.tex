...
Annualized Return & \textbf{93.31\%} & 31.09\% \\
Annualized Volatility & 16.89\% & \textbf{16.78\%} \\
Sharpe Ratio & \textbf{5.52} & 1.85 \\
Sortino Ratio & \textbf{8.67} & 2.89 \\
Maximum Drawdown & \textbf{8.31\%} & 17.06\% \\
Calmar Ratio & \textbf{11.23} & 1.82 \\
Win Rate & \textbf{62.3\%} & 54.8\% \\
Average Daily Return & \textbf{0.37\%} & 0.12\% \\
\midrule
Options P\&L & \textbf{+\$126,568} & +\$5,758 \\
Protective Put Usage & \textbf{44.87\%} & 0.08\% \\
Covered Call Usage & \textbf{75.62\%} & 2.98\% \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item DDPG generates substantially higher options hedging profits through aggressive use of both protective puts (44.87\%) and covered calls (75.62\%)
...
\midrule
Total Return & \textbf{219.40\%} & 61.12\% & 42.35\% & 33.89\% \\
Annualized Return & \textbf{93.31\%} & 31.09\% & 19.42\% & 15.68\% \\
Sharpe Ratio & \textbf{5.52} & 1.85 & 0.56 & 0.89 \\
Max Drawdown & \textbf{8.31\%} & 17.06\% & 43.21\% & 33.92\% \\
Volatility & 16.89\% & 16.78\% & 24.31\% & 18.74\% \\
Calmar Ratio & \textbf{11.23} & 1.82 & 0.45 & 0.46 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    \item \textbf{DDPG outperforms SPY by 6.2$\times$} in Sharpe ratio (5.52 vs 0.89)
    \item \textbf{DDPG limits drawdown to 8.31\%} while SPY suffered 33.92\% during COVID-19
    \item \textbf{Equal-weight strategy} diversifies but still experiences 43\% drawdown due to lack of active risk management
    \item \textbf{PPO doubles SPY's Sharpe ratio} despite more conservative positioning
\end{itemize}
