...
Figure \ref{fig:risk_analysis} provides a comprehensive visualization of the risk management performance.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/risk_analysis.png}
\caption{Risk management analysis: (a) Risk metrics comparison showing both agents meeting the $<$10\% max drawdown target, (b) Drawdown over time during test period, (c) Risk-adjusted return ratios, (d) Performance summary including win rates and total returns.}
