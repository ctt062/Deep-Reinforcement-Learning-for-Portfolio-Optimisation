"""
Training script for DRL portfolio optimization agents.
...
def create_environment(config: dict, train_data: dict, agent_type: str):
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train DRL agent for portfolio optimization")
    parser.add_argument(
        '--agent',
        type=str,
        default='ppo',
    ...
    model_name = f"{args.agent}_{timestamp}"
